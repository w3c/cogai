...
* An open discussion on recent work on deep learning, e.g. Google's [DreamBooth](https://dreambooth.github.io), and the challenges for achieving scalable learning for machine-based reasoning
