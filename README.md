...
We have a weekly zoom teleconference slot every Monday at 5pm Paris local time. An agenda will be sent in advance when a meeting is scheduled. This is open to all members of the Cognitive AI Community Group. The zoom URL is given on the [member only page for the meeting details](https://lists.w3.org/Archives/Member/internal-cogai/2020Sep/0000.html). To access that page, you will need to log in using your W3C account. Please don't share the Zoom URL on any public media.
