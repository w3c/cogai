...
**Scene Understanding Tasks**: These models describe images or video, either in terms of nodes and labelled arcs between them, or with natural language when given language priors. Related techniques include message passing (Graph Neural Networks) and relational transformers that allow objects to attend to every other object
